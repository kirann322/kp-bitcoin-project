...
from utils import hash256, little_endian_to_int, read_varint, int_to_little_endian, encode_varint
...
class Transaction:
    """
    Transaction class contains the contents of a transaction, which typical consists of the version, input, output, and locktime.
    """

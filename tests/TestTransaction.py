from src.elliptic_curve_cryptography.DigitalSignature import PrivateKey
...
class TransactionTest(unittest.TestCase):
    ...
    def test_parse_version(self):
        ...
        tx = Transaction.parse_transaction(stream)
    ...
    def test_parse_inputs(self):
        ...
        self.assertEqual(tx.tx_ins[0].script_sig.serialize_script(), want)
    ...
    def test_parse_outputs(self):
        ...
        self.assertEqual(tx.tx_outs[0].script_pubkey.serialize_script(), want)
        want = 10011545
        self.assertEqual(tx.tx_outs[1].amount, want)
        want = bytes.fromhex('1976a9141c4bc762dd5423e332166702cb75f40df79fea1288ac')
        self.assertEqual(tx.tx_outs[1].script_pubkey.serialize_script(), want)
    ...
    def test_serialize_transaction(self):
        ...
        stream = BytesIO(raw_tx)
        tx = Transaction.parse_transaction(stream)
        self.assertEqual(tx.serialize_transaction(), raw_tx)
    ...
    def test_input_pubkey(self):
        ...
        self.assertEqual(tx_in.script_pubkey().serialize_script(), want)
    ...
    def test_sign_input(self):
        ...
        tx_obj = Transaction.parse_transaction(stream, testnet=True)
        ...
        self.assertEqual(tx_obj.serialize_transaction().hex(), want)
